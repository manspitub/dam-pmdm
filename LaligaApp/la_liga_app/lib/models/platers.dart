...
class PlayersResponse {
	...
	late final List<Null>? errors;
	late final int? results;
	late final Paging? paging;
	late final List<Response>? response;

	PlayersResponse({this.get, this.parameters, this.errors, this.results, this.paging, this.response});
...
class Statistics {
	...
	Statistics({this.team, this.league, this.games,  this.shots, this.goals, this.passes, this.tackles, this.duels, this.dribbles, this.fouls, this.cards, this.penalty});
