class TopScorersResponse {
  ...
  late final List<TopScoresrs> response;
  
  TopScorersResponse.fromJson(Map<String, dynamic> json){
    get = json['get'];
    parameters = Parameters.fromJson(json['parameters']);
    errors = List.castFrom<dynamic, dynamic>(json['errors']);
    results = json['results'];
    paging = Paging.fromJson(json['paging']);
    response = List.from(json['response']).map((e)=>TopScoresrs.fromJson(e)).toList();
  }
...
class TopScoresrs {
  ...
  TopScoresrs.fromJson(Map<String, dynamic> json){
