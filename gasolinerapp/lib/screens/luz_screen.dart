                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text("Precio Medio", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
                              Padding(
                          ...
                          Row(
                            children: [
                              Text(nowFormatted, style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
                            ],
                          )
                        ],
                      ),
